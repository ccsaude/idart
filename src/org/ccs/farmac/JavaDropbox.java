...
public class JavaDropbox {
	...
	private static final String DROP_BOX_APP_KEY = "6v7biz9y9n7i3t6";
	private static final String DROP_BOX_APP_SECRET = "m0j75hfzbhjorvy";
	DbxClient dbxClient;
	...
	public DbxClient authDropbox(String dropBoxAppKey, String dropBoxAppSecret)
		...
		DbxRequestConfig dbxRequestConfig = new DbxRequestConfig("IdartFarmac", Locale.getDefault().toString());
	...
	public static void main(String[] args) throws IOException, DbxException {
		...
		javaDropbox.uploadToDropbox("C:\\Users\\colaco\\Documents\\pgadmin.log");
		javaDropbox.createFolder("tutorial");
		javaDropbox.listDropboxFolders("/");
		javaDropbox.downloadFromDropbox("pgadmin.log");
