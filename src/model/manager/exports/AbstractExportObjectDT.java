...
public abstract class AbstractExportObjectDT implements PackageExportObjectDT {
	...
	public AbstractExportObjectDT() {
		super();
	}
	
	public AbstractExportObjectDT(String title, Class dataType) {
		this.title = title;
	...
	@Override
	public DrugDispensedObjectDT clone() {
		try {
			return (DrugDispensedObjectDT) super.clone();
