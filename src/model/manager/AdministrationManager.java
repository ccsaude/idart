 ...
 */
    public static RegimeTerapeutico getRegimeById(Session sess, int regimeId) {
...
/*
 * 
 * Devolve um regimes terapeuticos
 * Metodo para buscar regimes terapeuticos - Idart antigo 
 * Modified by : Agnaldo Samuel
 * Modifica date: 27/03/2017
 */
 ...
 /*
 * Grava o  regime terapeutico na base de dados - Idart antigo
 * Metodo para buscar regime terapeutico - Idart antigo 
 * Modified by : Agnaldo Samuel
 * Modifica date: 27/03/2017
 */
...
//Previous Pediatric or Adult ARV
    ...
    public static IdentifierType getCRAMIdentifierType(Session hSession) {
        // FIXME: figure out a way to identify the national id type
        return (IdentifierType) hSession.createQuery(
                "from IdentifierType where id = 4").uniqueResult();
    }
